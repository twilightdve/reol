...
export type AudioPeakEvent = {
  timeSec: Seconds;
  strength: Normalized;
  band: "low" | "mid" | "high" | "full";
};

export type PseudoInstrumentEvent = {
  timeSec: Seconds;
...
export type AudioAnalysisCache = {
  ...
  durationSec?: Seconds;
  bpm?: number;
  bpmConfidence?: Normalized;
  beats: BeatEvent[];
  peaks: AudioPeakEvent[];
  pseudoInstrumentEvents: PseudoInstrumentEvent[];
...
export type PlaybackQueueItemKind =
  | "track"
  | "afterglow"
  | "gap"
  | "special";
