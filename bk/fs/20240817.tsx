            ...
            <div className="absolute w-full top-[3.4rem]">
              <div className="text-center text-[0.95rem] leading-[1.9rem] tracking-wider">
                ...
                <p className="">
                  【企画デザイン】
                  <br />
                  <a href="https://twitter.com/flower_23s" target="_blank" rel="noopener noreferrer">
                    有架 (@flower_23s)
                  ...
                  【集合イラスト】
                  <br />
                  <a href="https://twitter.com/Ori_hara_oxo" target="_blank" rel="noopener noreferrer">
                    折原 (@Ori_hara_oxo)
                    <FaXTwitter className="inline-block ml-3 mb-1 text-[0.74rem]" />
                    <GoLinkExternal className="inline-block mb-4 text-[0.5rem]" />
                  </a>
                  <br />
                  <a href="https://twitter.com/pinpon__Ooatari" target="_blank" rel="noopener noreferrer">
                    きき (@pinpon__Ooatari)
                    <FaXTwitter className="inline-block ml-3 mb-1 text-[0.74rem]" />
                    <GoLinkExternal className="inline-block mb-4 text-[0.5rem]" />
                  </a>
                  <br />
                  <a href="https://twitter.com/RRRium" target="_blank" rel="noopener noreferrer">
                    きむら (@RRRium)
                    <FaXTwitter className="inline-block ml-3 mb-1 text-[0.74rem]" />
                    <GoLinkExternal className="inline-block mb-4 text-[0.5rem]" />
                  </a>
                  <br />
                  <a href="https://twitter.com/nanashi_tabi113" target="_blank" rel="noopener noreferrer">
                  ...
                  <br />
                  <a href="https://twitter.com/onikutabetainja" target="_blank" rel="noopener noreferrer">
                    ゆねち (@onikutabetainja)
                    <FaXTwitter className="inline-block ml-3 mb-1 text-[0.74rem]" />
                    <GoLinkExternal className="inline-block mb-4 text-[0.5rem]" />
                  </a>
          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute w-full top-[3.4rem]">
              <div className="font-tegakifr font-extrabold text-center text-[1.2rem] leading-[1.9rem] tracking-wider">
                {Array.from({ length: Math.floor(lineNums / 2) - 1 }).map((_, index) => (
                  <br key={index} />
                ))}
