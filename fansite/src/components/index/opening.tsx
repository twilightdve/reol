      ...
      return (
        <>
          ...
          {this.state.introEnd && (
            <>
              <div
                className={`fixed inset-0 w-full h-full bg-black z-50 before:content-[''] before:absolute before:top-0 before:left-0 before:bottom-0 before:m-auto before:bg-[#ea6000] before:z-50 before:w-0 before:h-px will-change-auto transform-gpu${
                  this.state.unbox
              ...
              />
              <div
                className={`fixed left-1/4 top-3/4 -translate-x-1/2 -translate-y-1/2 font-bold text-4xl bg-black text-[#ea6000] z-50 -rotate-12 tracking-widest border-2 border-[#ea6000] pt-2 pb-3 px-5${
                  this.state.unbox ? " animate-unbox" : ""
                }`}
              >
              ...
              <div
                className={`fixed left-1/2 top-1/4 -translate-x-1/2 -translate-y-1/3 sm:-translate-y-1/2 font-bold text-4xl bg-[#ea6000] text-black z-50 -rotate-12 tracking-widest border-2 border-black pt-2 pb-3 px-5${
                  this.state.unbox ? " animate-unboxReverse" : ""
                }`}
              >
                BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX
              </div>
              <div
                className={`fixed left-3/4 top-1/2 -translate-x-1/2 -translate-y-1/2 font-bold text-4xl bg-black text-[#ea6000] z-50 rotate-45 tracking-widest border-2 border-[#ea6000] pt-2 pb-3 px-5${
                  this.state.unbox ? " animate-unbox" : ""
                }`}
              >
                BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX
              ...
              <div
                className={`fixed left-1/2 top-2/3 -translate-x-1/2 -translate-y-1/3 sm:-translate-y-1/2 font-bold text-4xl bg-[#ea6000] text-black z-50 rotate-12 tracking-widest border-2 border-black pt-2 pb-3 px-5${
                  this.state.unbox ? " animate-unboxReverse" : ""
                }`}
              >
                BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX&nbsp;&nbsp;BLACKBOX
              </div>
              <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transition-all perspective-9 perspective-origin-top z-50">
                <div
                ...
                >
                  ...
                  <div
                    className={`${boxBaseClass} -rotate-y-90 -translate-x-28`}
                  >
                    {this.renderCubeSide()}
                  </div>
                  ...
                  <div
                    className={`${boxBaseClass} -rotate-x-90 translate-y-28`}
                  >
                    {this.renderCubeSide()}
                  </div>
                  <div
              ...
              <div
                className={`fixed bottom-2 left-2 text-[#ea6000] z-50${
